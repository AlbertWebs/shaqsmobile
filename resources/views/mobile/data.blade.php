...
<a class="col-6 pr-2" href="detail1#html">
    ...
    <div class="p-2">
        ...
        <p class="small mb-2"><i class="mdi mdi-star text-warning"></i><i class="mdi mdi-star text-warning"></i><i class="mdi mdi-star text-warning"></i>  <span class="text-muted"> <span class="mdi mdi-circle-medium"></span> <?php $Cat = DB::table('category')->where('id',$menu->cat_id)->first() ?>{{$Cat->cat}}
